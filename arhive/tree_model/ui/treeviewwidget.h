...
namespace arcirk::tree_widget {
    ...
    class TREE_MODEL_EXPORT TreeViewWidget : public QTreeView
    {
        Q_OBJECT
    public:
        ...
        QModelIndex get_index(const QModelIndex& sort_index) const;
        ...
        void setTableToolBar(TreeToolBar* value);
        TreeToolBar* toolBar() const;
